  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex gap-3 items-center">
        ...
        <div className="w-72 px-3 py-1.5 border border-white/10 rounded-md flex items-center gap-3">
            ...
            {Array.from({ length: 7 }).map((_, i) => {
              return (
                <tr key={i} className="border-b border-white/10 hover:bg-white/5">
                  ...
                  <td className="py-3 px-4 text-sm text-zinc-300">158723</td>
                  <td className="py-3 px-4 text-sm text-zinc-300">
                    <div className="flex flex-col gap-1">
                      <span className="font-semibold text-white">Samuel Oliveira</span>
                      <span>samueloliveira@gmail.com</span>
                    </div>
                  </td>
